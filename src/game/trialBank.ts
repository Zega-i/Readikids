...
const BANKS: SkillBank[] = [
  ...
  // ───────────────── FASE 2 — HURUF & BUNYI ─────────────────
  {
    ...
    demo: [
      ...
      choiceItem('gp-d2', 'Bunyi apa untuk huruf ini?', [c('a', '/b/', { audio: 'buh' }), c('b', '/d/', { audio: 'duh' })], 'a', { stimulusText: 'b' }),
    ],
    items: [
      ...
      choiceItem('gp-2', 'Bunyi apa untuk huruf ini?', [c('a', '/b/', { audio: 'buh' }), c('b', '/d/', { audio: 'duh' }), c('c', '/p/', { audio: 'puh' })], 'a', { stimulusText: 'b', errorTags: { b: 'phonological', c: 'phonological' } }),
      choiceItem('gp-3', 'Bunyi apa untuk huruf ini?', [c('a', '/s/', { audio: 'sss' }), c('b', '/c/', { audio: 'cuh' }), c('c', '/t/', { audio: 'tuh' })], 'a', { stimulusText: 's', errorTags: { b: 'phonological', c: 'phonological' } }),
      ...
      choiceItem('gp-5', 'Bunyi apa untuk huruf ini?', [c('a', '/k/', { audio: 'kuh' }), c('b', '/g/', { audio: 'guh' }), c('c', '/h/', { audio: 'hhh' })], 'a', { stimulusText: 'k', errorTags: { b: 'phonological', c: 'phonological' } }),
      ...
      choiceItem('gp-7', 'Bunyi apa untuk huruf ini?', [c('a', '/g/', { audio: 'guh' }), c('b', '/k/', { audio: 'kuh' }), c('c', '/j/', { audio: 'juh' })], 'a', { stimulusText: 'g', errorTags: { b: 'phonological', c: 'phonological' } }),
  ...
  },
  {
    ...
    demo: [
      ...
      choiceItem('pg-d2', 'Huruf mana yang berbunyi /b/?', [c('a', 'b'), c('b', 'd')], 'a', { stimulusAudio: 'buh' }),
    ],
    items: [
      ...
      choiceItem('pg-3', 'Huruf mana yang berbunyi /d/?', [c('a', 'b'), c('b', 'd'), c('c', 't')], 'b', { stimulusAudio: 'duh', errorTags: { a: 'visual-similar', c: 'phonological' } }),
      choiceItem('pg-4', 'Huruf mana yang berbunyi /o/?', [c('a', 'o'), c('b', 'a'), c('c', 'u')], 'a', { stimulusAudio: 'o', errorTags: { b: 'phonological', c: 'phonological' } }),
      choiceItem('pg-5', 'Huruf mana yang berbunyi /k/?', [c('a', 'k'), c('b', 'g'), c('c', 'q')], 'a', { stimulusAudio: 'kuh', errorTags: { b: 'phonological', c: 'visual-similar' } }),
      ...
      choiceItem('pg-7', 'Huruf mana yang berbunyi /g/?', [c('a', 'g'), c('b', 'k'), c('c', 'j')], 'a', { stimulusAudio: 'guh', errorTags: { b: 'phonological', c: 'phonological' } }),
      choiceItem('pg-8', 'Huruf mana yang berbunyi /p/?', [c('a', 'b'), c('b', 'p'), c('c', 'q')], 'b', { stimulusAudio: 'puh', errorTags: { a: 'phonological', c: 'visual-similar' } }),
    ],
  },
  {
    skillId: 'digraph',
  ...
  // ───────────────── FASE 3 — BUNYI KATA ─────────────────
  {
    ...
    demo: [
      choiceItem('sp-d1', 'Kata "mata" diawali bunyi apa?', [c('a', '/m/', { audio: 'mmm' }), c('b', '/t/', { audio: 'tuh' })], 'a', { stimulusAudio: 'mata' }),
      choiceItem('sp-d2', 'Kata "susu" diawali bunyi apa?', [c('a', '/s/', { audio: 'sss' }), c('b', '/m/', { audio: 'mmm' })], 'a', { stimulusAudio: 'susu' }),
    ],
    items: [
      choiceItem('sp-1', 'Kata "bola" diawali bunyi apa?', [c('a', '/b/', { audio: 'buh' }), c('b', '/l/', { audio: 'lll' }), c('c', '/a/', { audio: 'a' })], 'a', { stimulusAudio: 'bola', errorTags: { b: 'position-swap', c: 'position-swap' } }),
      choiceItem('sp-2', 'Kata "sapi" diakhiri bunyi apa?', [c('a', '/s/', { audio: 'sss' }), c('b', '/i/', { audio: 'i' }), c('c', '/p/', { audio: 'puh' })], 'b', { stimulusAudio: 'sapi', errorTags: { a: 'position-swap', c: 'position-swap' } }),
      ...
      choiceItem('sp-4', 'Kata "buku" diakhiri bunyi apa?', [c('a', '/u/', { audio: 'u' }), c('b', '/b/', { audio: 'buh' }), c('c', '/k/', { audio: 'kuh' })], 'a', { stimulusAudio: 'buku', errorTags: { b: 'position-swap', c: 'position-swap' } }),
      choiceItem('sp-5', 'Kata "roti" diawali bunyi apa?', [c('a', '/r/', { audio: 'rrr' }), c('b', '/t/', { audio: 'tuh' }), c('c', '/i/', { audio: 'i' })], 'a', { stimulusAudio: 'roti', errorTags: { b: 'position-swap', c: 'position-swap' } }),
      choiceItem('sp-6', 'Kata "meja" diakhiri bunyi apa?', [c('a', '/a/', { audio: 'a' }), c('b', '/m/', { audio: 'mmm' }), c('c', '/j/', { audio: 'juh' })], 'a', { stimulusAudio: 'meja', errorTags: { b: 'position-swap', c: 'position-swap' } }),
      choiceItem('sp-7', 'Kata "kuda" diawali bunyi apa?', [c('a', '/k/', { audio: 'kuh' }), c('b', '/d/', { audio: 'duh' }), c('c', '/u/', { audio: 'u' })], 'a', { stimulusAudio: 'kuda', errorTags: { b: 'position-swap', c: 'position-swap' } }),
      choiceItem('sp-8', 'Kata "padi" diakhiri bunyi apa?', [c('a', '/p/', { audio: 'puh' }), c('b', '/i/', { audio: 'i' }), c('c', '/d/', { audio: 'duh' })], 'b', { stimulusAudio: 'padi', errorTags: { a: 'position-swap', c: 'position-swap' } }),
    ],
  },
  {
    skillId: 'blending',
    ...
    items: [
      ...
      choiceItem('bl-4', 'Gabungkan dua bunyi ini.', [c('a', 'kucing', { image: '🐱' }), c('b', 'kancing', { image: '🔘' }), c('c', 'gunting', { image: '✂️' })], 'a', { stimulusAudio: ['ku', 'cing'], errorTags: { b: 'substitution', c: 'substitution' } }),
      // Beban bertingkat: 2 → 3 → 4 suku (kurva kapasitas fonologis; docs/fase-membaca.md 3a).
      choiceItem('bl-5', 'Gabungkan tiga bunyi ini.', [c('a', 'sepeda', { image: '🚲' }), c('b', 'sepatu', { image: '👟' }), c('c', 'sapi', { image: '🐄' })], 'a', { stimulusAudio: ['se', 'pe', 'da'], errorTags: { b: 'substitution', c: 'substitution' } }),
      choiceItem('bl-6', 'Gabungkan tiga bunyi ini.', [c('a', 'kelapa', { image: '🥥' }), c('b', 'kereta', { image: '🚂' }), c('c', 'kepala', { image: '🙂' })], 'a', { stimulusAudio: ['ke', 'la', 'pa'], errorTags: { b: 'substitution', c: 'substitution' } }),
      choiceItem('bl-7', 'Gabungkan empat bunyi ini.', [c('a', 'matahari', { image: '☀️' }), c('b', 'mata', { image: '👀' }), c('c', 'madu', { image: '🍯' })], 'a', { stimulusAudio: ['ma', 'ta', 'ha', 'ri'], errorTags: { b: 'substitution', c: 'substitution' } }),
      choiceItem('bl-8', 'Gabungkan empat bunyi ini.', [c('a', 'kupu-kupu', { image: '🦋' }), c('b', 'kucing', { image: '🐱' }), c('c', 'kuda', { image: '🐴' })], 'a', { stimulusAudio: ['ku', 'pu', 'ku', 'pu'], errorTags: { b: 'substitution', c: 'substitution' } }),
    ],
  },
  {
    skillId: 'segmenting',
